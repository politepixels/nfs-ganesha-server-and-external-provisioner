...
var (
	...
	configMap          = flag.String("configmap", "", "Configmap with default exports.")
	configMapNamespace = flag.String("configmap-namespace", "", "Configmap namespace with default exports.")
)
...
func main() {
	...
	// the controller
	nfsProvisioner := vol.NewNFSProvisioner(exportDir, clientset, outOfCluster, *useGanesha, ganeshaConfig, *enableXfsQuota, *serverHostname, *maxExports, *exportSubnet, *configMap, *configMapNamespace)
